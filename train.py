...
if __name__ == '__main__':
    ...
    data_module = MovieDataModule(config)


    logging.info("Setting up the model..")
    model = LightT2VSAS(config)
    ...
    #model = LightT2VSAS.load_from_checkpoint("/Users/umergupta/Library/Mobile Documents/com~apple~CloudDocs/Documents/UoE/diss_exps/time/t2v_aa/checkpoints/epoch=39-step=71640.ckpt")
    #logging.info("Testing the model..")
